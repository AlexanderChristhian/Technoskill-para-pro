        ...
        <div className="flex items-center justify-center h-screen w-full px-5 sm:px-0">
          <div className="flex bg-white rounded-lg shadow-lg overflow-hidden max-w-sm lg:max-w-4xl w-full">
            <div
              ...
              style={{
                backgroundImage: `url(https://cdni.iconscout.com/illustration/premium/thumb/user-login-7210570-5857593.png)`,
              }}
            ></div>
            <div className="w-full p-8 lg:w-1/2">
              <p className="text-xl text-gray-600 text-center">Lets Create A New Account!</p>
              <div className="mt-4">
